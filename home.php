    ...
    <body>
        ...
        <div id="main"> <!--Maid Available Online-->
            ...
            <div>
                ...
                <div class="job-seeker-reg">Register as Job Seeker</div>
            </div>
        </div>
        ...
        <footer>
            ...
            <!-- <table>
                ...
                <tr class="table-row">
                    ...
                    <td>
                        <ul>
                            <li><a href="mailto:customer@maidonline.com">Contact email: customer@maidonline.com</a></li><br>
                            <li>Contact No.: 180052413600</li>
                        </ul>
                    </td>
                    <td>
